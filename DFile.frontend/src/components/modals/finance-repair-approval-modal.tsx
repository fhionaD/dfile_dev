        ...
        <Dialog open={open} onOpenChange={handleClose}>
            <DialogContent className="sm:max-w-xl max-h-[90vh] overflow-y-auto">
                ...
                <div className="space-y-5 py-2">
                    ...
                    {maintenanceRecord && (
                        <div className="rounded-lg border bg-muted/20 p-4 space-y-3">
                            <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">Repair Details</p>
                            <dl className="space-y-3 text-sm">
                                ...
                                {repairDescription && (
                                    <div>
                                        ...
                                        <dd className="text-foreground/90 whitespace-pre-wrap">{repairDescription}</dd>
                                    </div>
                                )}
                            </dl>
                        </div>
                    ...
                    <div className="space-y-3 border-t pt-4">
                        <Label>Financial Impact Decision</Label>
                        <div className="space-y-2">
                            {/* Expense Only */}
                            <button
                                type="button"
                                onClick={() => setDecision("Expense")}
                                className={`w-full flex items-start gap-3 p-3 rounded-lg border cursor-pointer transition-colors text-left ${
                                    decision === "Expense"
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    <p className="text-sm font-medium">Treat as Expense</p>
                            ...
                            >
                                ...
                                />
                                <div className="flex-1">
                                    <p className="text-sm font-medium">Increase Asset Value</p>
                            ...
                            >
                                ...
                                />
                                <div className="flex-1">
                                    <p className="text-sm font-medium">Extend Useful Life</p>
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    <p className="text-sm font-medium">Both: Increase Value & Extend Life</p>
                    ...
                    {(decision === "IncreaseValue" || decision === "Both") && (
                        <div className="space-y-3 border-t pt-4">
                            <Label htmlFor="adjustment-value">Amount to Increase Asset Value (PHP)</Label>
                            <Input
                                id="adjustment-value"
                                type="number"
                                min={0}
                    ...
                    {(decision === "ExtendLife" || decision === "Both") && (
                        <div className="space-y-3 border-t pt-4">
                            <Label htmlFor="added-life-months">Additional Useful Life (months)</Label>
                            <Input
