...
export default function CreateTenantPage() {
    ...
    const handleTenantCreated = () => {
        // Increment key to force TenantList to re-mount and re-fetch data
                    ...
                    <div className="w-full">
                        <Card className="border-border shadow-sm rounded-xl">
                            ...
                            <CardContent className="p-6">
                                <TenantRegistrationForm onTenantCreated={handleTenantCreated} />
                            </CardContent>
                        </Card>
                    </div>
                </div>

                {/* Tenant List — key changes force re-mount and re-fetch */}
                <div className="w-full">
